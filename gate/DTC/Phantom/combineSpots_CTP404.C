...
void combineSpots_CTP404(Int_t rotation) {
   ...
   fSimulationOut = new TFile(Form("../../../DTCToolkit/Data/MonteCarlo/DTC_Final_CTP404_rotation%03ddeg.root", rotation), "recreate");
   ...
   for (int spotX = -77; spotX <= 77; spotX += 7) {
      for (int spotY = -21; spotY <= 21; spotY += 7) {
         ...
         fSimulationIn = new TFile(Form("../../../DTCToolkit/Data/MonteCarlo/DTC_Final_CTP404_rotation%03ddeg_spotx%04d_spoty%04d.root", rotation, spotX, spotY), "READ");
