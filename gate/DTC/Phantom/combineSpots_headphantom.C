...
void combineSpots_headphantom(Int_t rotation) {
   ...
   fSimulationOut = new TFile(Form("../../../DTCToolkit/Data/MonteCarlo/DTC_Final_headphantom_rotation%03ddeg.root", rotation), "recreate");
