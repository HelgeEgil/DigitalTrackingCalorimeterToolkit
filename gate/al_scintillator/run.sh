...
echo Energy_from: $1, energy_increment: $2, energy_to: $3, npart: $4, accuracy um: $5, sigma MeV: $6
...
for i in `seq $1 $2 $3`;
do
	time Gate -a "'[energy,$i] [npart,$4] [step_active,$5] [sigma,$6]'" focal.mac > terminal_output.txt &
done
