...
// float findMLP(Double_t phantomSize = 200, Double_t rotation = -1, Double_t spotsize = -1, Double_t initialEnergy = 230, Int_t material = kWater, Int_t kModelType = kUiB, Bool_t kModelUncertainties = true, Float_t a=1, Float_t b=1) {
double findMLP(const double *aa) {
   double     Lambdaa = aa[0];
   double     Lambdab = aa[1];
   ...
   Double_t    arSplineMCx[1000], arSplineMCy[1000], arSplineMCz[1000], arSplineMLPz[1000];
