...
for i in `seq -f "%03g" 10 10 600`; do
...
#   divergence=`echo "scale=3; $i/100" | bc`
   ...
   Gate -a "'[energy,330] [dz,$i] [ztracker,$ztracker] [zbeam,$zbeam] [spotsize,3] [divergence,2] [emittance,15] [rotation,0] [material,Water] [zcalorimeter,$zcalorimeter]'" MLPscanner.mac > terminal_output.txt &
   PIDLIST="$PIDLIST $!"
