...
*/
   ...
   for (Int_t i=0; i<idxDifferenceArray; i++) {
      ...
      differenceArrayKrahSchulte[i] = 1000*fabs(differenceArrayDiffKrah[i] - differenceSplineDiffKrah[i]);
   }
...
//   gDifferencePerfect->SetLineWidth(2);
   ...
   gDifferenceSchulte->SetLineWidth(3);
...
//   l->AddEntry(gDifferencePerfect, "Measure X_{0}", "L");
   ...
   gDifferenceKrahSchulte->SetLineColor(kBlue-4);
   gDifferenceKrahSchulte->SetLineWidth(3);
