...
void findManyRanges(Int_t degraderFrom, Int_t degraderIncrement, Int_t degraderTo, Int_t mmFrom, Int_t mmIncrement, Int_t mmTo) {
   ...
   ifstream in;
   printf("a\n");
   in.open("../Data/Ranges/EnergyAfterDegraderPSTAR230MeV.csv");
   ...
   std::ofstream filename("../OutputFiles/findManyRangesDegrader_230MeV.csv"); // , std::ofstream::out || std::ofstream::app);
